...
CHECK_SCORE_AND_OPTIONS:
  ...
  lis r15, 0x80c5       
  ori r15, r15, 0xf22b  # Load 80c5f22b (address of game mode) into r15
  lbz r15, 0 (r15)      # Load value of game mode (0 = timed, 1 = first to X) into r15
  cmpwi cr2, r15, 1     # Are we in First to X mode?
  bne- cr2, FINALLY     # If not, clean up.
