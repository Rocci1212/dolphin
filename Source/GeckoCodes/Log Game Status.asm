...
### COPY CURRENT SCORE/ITEMS INTO THE EXCEPTION VECTOR AREA ###
  ...
  stw r14, 0x1bc (r23)				# home item 1
  stb r15, 0x1b8 (r23)				# home item 1 quantity
  stw r16, 0x1c0 (r23)				# home item 2
  stb r17, 0x1b9 (r23)				# home item 2 quantity
